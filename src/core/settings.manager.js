class SettingsManager {
  ...
  #setupServer () {
    ...
    console.log(` ${this._dependencies.colors.green(`${this._namespace}:`)} Configured server middlewares`)
  }
  ...
  #ioConfigs () {
    ...
    this._express.use(this._dependencies.bodyParser.urlencoded({ extended: true })) // support encoded bodies
