...
class DeviceManagementModel extends BaseModel {
  constructor(args, dependencies) {
    ...
    this.status = {
      value: args.status || DeviceManagementModel.statuses.active,
      type: this._types.object,
    };
  ...
  get sanitized() {
    return {
      ...
      operating_system_name:
        this.operating_system_name.value ||
        this.operating_system_name.type.default,
      operating_system_version:
        this.operating_system_version.value ||
        this.operating_system_version.type.default,
    };
  }
