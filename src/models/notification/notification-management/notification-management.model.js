...
class NotificationManagementModel extends BaseModel {
  constructor(args, dependencies) {
    ...
    this.status = {
      value: args.status || NotificationManagementModel.statuses.active,
      type: this._types.object,
    };
  ...
  get sanitized() {
    return {
      ...
      receiver_user_id:
        this.receiver_user_id.value || this.receiver_user_id.type.default,
      subject: this.subject.value || this.subject.type.default,
      message_resume:
        this.message_resume.value || this.message_resume.type.default,
      sender_user_id:
        this.sender_user_id.value || this.sender_user_id.type.default,
...
NotificationManagementModel.folders = {
  ...
  junk: {
    id: 3,
    name: 'junk',
    title: 'SIDE_DRAFT_OPTION',
    icon: 'mdi-file-outline',
  },
  draft: {
    id: 4,
    name: 'draft',
    title: 'SIDE_TRASH_OPTION',
    icon: 'mdi-delete',
  },
};
